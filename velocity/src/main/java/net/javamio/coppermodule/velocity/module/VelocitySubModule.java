...
@Getter
public abstract class VelocitySubModule extends AbstractSubModule {
    ...
    protected VelocitySubModule(final @NotNull String identifier, final @NotNull String displayName, final @NotNull Module parentModule, final @NotNull Object plugin, final @NotNull ProxyServer server) {
